...
vehicle_jump_impulse_distance : SliderOption = SliderOption("Vehicle Jump Impulse Distance", 500.0, 1.0, 1000.0, 0.1, False, description="Vehicle Jump Impulse Distance (default 500.0)")
vehicle_jump_impulse_magnitude : SliderOption = SliderOption("Vehicle Jump Impulse Magnitude", 100.0, 1.0, 1000.0, 0.1, False, description="Vehicle Jump Impulse Magnitude (default is 100.0)")
